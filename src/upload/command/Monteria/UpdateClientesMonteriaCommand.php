...
class UpdateClientesMonteriaCommand extends Command
{   
    ...
    public $bolivar = 'e296f778-e194-495a-a07d-98a6cbba974a';  //Cordoba
    public $cartagena = 'e296f778-e194-495a-a07d-98a6cbba974a'; //Monteria
    ...
    {
        $this->setName('updateClientesMonteria')
                               ...
                               \Symfony\Component\Console\Output\OutputInterface $output)
    {
        ...
        $conexion = new clientsCartagena($conn);
        
        $this->updateClientes($conexion);
        
    }
  
 
    function updateClientes($conexion) {
        
        
         
        $clients = $conexion->getClientesUpdate();
        ...
        for ($i = 0; $i < $totalClients; $i++) {
            ...
            if(!is_null($clientSF2)){
                ...
                if($client['nat_juridica'] == 'N'){
                    ...
                    $urlapiClient = $this->server.'crm/main/clientperson/'.$clientSF2['id'];
                     
                    echo "\n".$urlapiClient."\n";
                    $apiClient = $this->SetupApi($urlapiClient, $this->user, $this->pass);
                     
                     
                    $bClient = $this->buildClintePersona($client, $clientSF2);
                
                    $json = json_encode($bClient);
                    echo "\n".$json."\n";
                    
                    $result = $apiClient->put($bClient);
                    ...
                    $urlapiClient = $this->server.'crm/main/clientcompany/'.$clientSF2['id'];
                    //echo "\n".$urlapiClient."\n";
                    ...
                    $bClient = $this->buildClintePersonaJuridica($client, $clientSF2);
                ...
                echo "\nEl cliente no existe: ".$client['id_cliente']."\n";
            }
...
//      echo "\nTotal de clintes con error en SF2: ".count($clientErrors)."\n";
    ...
    function buildClintePersona($client, $clientSF2) {
...
//      return $result;
    ...
    function buildClintePersonaJuridica($client, $clientSF2) {
