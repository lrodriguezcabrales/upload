...
class ContratosDeMandatoMonteriaCommand extends Command
{	
    ...
    {
        $this->setName('contratosmandatoMonteria')
		             ->setDescription('Comando para pasar contratos de mandato - Monteria');
	}
    ...
    public function crearContratosDeMandato($conexion) {
    	...
    	$contratosMandatoSF1 = $conexion->getContratosDeMandatoMonteria();
...
//     /**
//      * Crear contratos de mandato para un convenio especifico
//      * @param unknown $conexion
//      */
//     public function crearContratosDeMandatoPorDemanda($conexion) {
    
//     	$convenio = '29564';
    	 
//     	$contratosMandato = $conexion->getContratoMandatoDelConvenio($convenio);
