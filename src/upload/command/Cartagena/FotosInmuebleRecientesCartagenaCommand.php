...
class FotosInmuebleRecientesCartagenaCommand extends Command
{	
    ...
    {
        $this->setName('fotosRecientesCartagena')
    ...
    function buildFotos($inmueblesCtg) {
    	...
    	$inmueblesSF2 = $inmueblesCtg->getInmueblesFotosRecientes();
    	...
    	if($totalInmueblesSF2 > 0){
    		...
    		//foreach ($inmueblesSF2 as $inmueble) {
    				...
    				if(!is_null($property)){
    					...
    					$urlFotoSF1 = 'http://10.102.1.6/ws-img/foto.php?key=C';
