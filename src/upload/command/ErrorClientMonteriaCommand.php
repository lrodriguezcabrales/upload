...
class ErrorClientMonteriaCommand extends Command
{	
...
// 	public $serverRoot = 'http:/10.102.1.22/';
    ...
    {
        $this->setName('errorclientMonteria')
							   ...
							   \Symfony\Component\Console\Output\OutputInterface $output)
	{
        ...
        $output->writeln("Clientes con error \n");
    ...
    function searchErrorInmueble() {
    	...
    	$urlErrorProperty = $this->server.'crm/main/errorclient';
    	...
    	if($totalErrores > 0){
    		...
    		$urlapiInmueble = $this->server.'crm/main/client';
    		...
    		for ($i = 0; $i < 1; $i++) {
    			...
    			if(isset($error['client'])){
    				
    				$propertySF2 = $this->searchClientSF2($error['client']);
...
//     				$i--;
    ...
    function searchPropertySF2($propertySF1) {
    	...
    	$urlProperty = $this->server.'crm/main/property?filter='.$filter;
