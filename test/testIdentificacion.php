...
use upload\model\identificacion;
use upload\lib\data;
use upload\lib\api;
...
$identificacion = new identificacion($db);

$data=$identificacion->getIds();
print_r($data);
// return null;
...
$url = "http://10.102.1.22/sifinca/web/app.php/admin/sifinca/zeus/idtype";
$apidocumenttype = SetupApi($url,$user,$pass);
$result = json_decode($apidocumenttype->post($data), true);
print_r($result);
